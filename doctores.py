...
def registrarDoctor():
    doctor = {
        ...
        "Años de experiencia": entryAñosdeexperiencia.get(),
        "Genero": genero.get(), 
...
# Edad
labelAñosdeexperiencia = tk.Label(frameDoctores, text="Años de experincia:")
labelAñosdeexperiencia.grid(row=2, column=0, padx=5, pady=5, sticky="w")
entryAñosdeexperiencia= tk.Spinbox(frameDoctores,from_=0,to=100, width=5)
entryAñosdeexperiencia.grid(row=2, column=1, padx=5, pady=5, sticky="w")
# Genero
labelGeneroD = tk.Label(frameDoctores, text="Genero:")
labelGeneroD.grid(row=3, column=0, padx=5, pady=5, sticky="w")
genero = tk.StringVar()
genero.set("Masculino") # Valor por defecto
radioMasculino = ttk.Radiobutton(frameDoctores, text="Masculino", variable=genero, value="Masculino")
radioMasculino.grid(row=3, column=1, padx=5, sticky="w")
radioFemenino = ttk.Radiobutton(frameDoctores, text="Femenino", variable=genero, value="Femenino")
...
entryHospitalD = tk.Entry(frameDoctores)
entryHospitalD.grid(row=4, column=1, padx=5, pady=5, sticky="w")
# Frame para botones
btnFrameD = tk.Frame(frameDoctores)
btnFrameD.grid(row=10, column=1, columnspan=2, pady=5, sticky="w")
btnRegistrarD = tk.Button(btnFrameD, text="Registrar", bg="green", fg="white", command=registrarDoctor)
btnRegistrarD.grid(row=10, column=10, padx=5)

# Treeview para mostrar doctores
treeviewD = ttk.Treeview(frameDoctores, columns=("Nombre", "Especialidad", "Años de experiencia", "Genero", "Hospital"), show="headings")
...
treeviewD.heading("Genero", text="Generoo")
